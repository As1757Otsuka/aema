...
// PARSER IMPORTS
import heroConditionsParser from './parsers/hero-conditions.js';

// TRANSFORMER IMPORTS
import cleanupTransformer from './transformers/rexulti-cleanup.js';
import sectionsTransformer from './transformers/rexulti-sections.js';

// PARSER REGISTRY
const parsers = {
  'hero-conditions': heroConditionsParser,
};
...
export default {
  transform: (payload) => {
    ...
    // 6. Generate path (runner re-sanitizes via sanitizeDocumentPath)
